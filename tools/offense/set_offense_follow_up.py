...
"""
Set Offense Follow Up Tool

Sets the follow-up flag on a QRadar offense.
"""
...
class SetOffenseFollowUpTool(MCPTool):
    """Tool for setting the follow-up flag on a QRadar offense."""

    @property
    def name(self) -> str:
        return "set_offense_follow_up"

    @property
    def description(self) -> str:
        return """Set the follow-up flag on a QRadar offense."""
    ...
    async def _execute_impl(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        """
        Execute the set_offense_follow_up tool.

        Args:
            arguments: Dictionary containing offense_id, follow_up,
                and optional fields
    ...
    def _validate_arguments(
        ...
        if follow_up is None:
            return self.create_error_response("follow_up is required")
